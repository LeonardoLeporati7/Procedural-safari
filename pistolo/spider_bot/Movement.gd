...
@onready var rc_fl = $Node3D/StepTargetContainer/FrontLeftRay
@onready var rc_fr = $Node3D/StepTargetContainer/FrontRightRay
@onready var rc_bl =$Node3D/StepTargetContainer/BackLeftRay
@onready var rc_br = $Node3D/StepTargetContainer/BackRightRay
